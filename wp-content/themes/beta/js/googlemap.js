 google.maps.event.addDomListener(window, 'load', function()
    {
        // BRISK の位置
        var briskLatLng = new google.maps.LatLng(34.6841084,135.5061917);
        var latlng = new google.maps.LatLng(34.6831909,135.503649);
        ...
        // MAPオブジェクトの作成
        var mapObj = new google.maps.Map(document.getElementById('osakamap'), mapOptions);
